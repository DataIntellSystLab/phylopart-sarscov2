...
Examples of input trees (standard NEWICK format):
	...
	Rules:
	- The tree is sorrounded by round brackets and ends with a semicolon.
	...
	- Intermediate nodes are sorrounded by round brackets.
...
In the main program window you will see that many lines are written. If you scroll down, you will find a special keyword "treshold:" (repeated many times) that tells you which is the corresponding nucleotide substitution per site value of the threshold used in input (so if you change the percentile, this value will change).
